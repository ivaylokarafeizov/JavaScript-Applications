...
const catalogTemplate = (recipes, goTo, page, pages) => html` <section
  id="catalog"
>
...
const recipePreview = (recipe, goTo) => html` <article
  class="preview"
...
const pager = (goTo, page, pages) => html` Page ${page} of ${pages}
${page > 1
  ? html`<a
      class="pager"
      href="/catalog"
      @click=${(e) => changePage(e, goTo, page - 1)}
      >&lt; Prev</a
    >`
  : ''}
${page < pages
